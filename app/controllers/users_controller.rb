class UsersController < ApplicationController
	...
	def login
		...
		user_info = User.extract_remote_params(User.load_api_data(params[:access_token]))
		if User.where(github_id: user_info[:github_id])
	...
	def create
		...
		if @user.save
			...
			redirect_to root_url notice: "There was an error loggin in"
		end
